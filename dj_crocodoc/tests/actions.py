...
class CrocodocCommentCreateEventTest(CrocodocBaseTest):
    ...
    expected_verb = 'Commented on a Document'
...
class CrocodocCommentDeleteEventTest(CrocodocBaseTest):
    ...
    expected_verb = 'Deleted a Commented on a Document'
...
class CrocodocAnnotationHighlightEventTest(CrocodocBaseTest):
    ...
    expected_verb = 'Hilighted some text on a Document'
    expected_deleted_verb = 'Deleted a Hilighted of some text on a Document'
...
class CrocodocAnnotationStrikeoutEventTest(CrocodocBaseTest):
    ...
    expected_verb = 'Struck out some text on a Document'
    expected_deleted_verb = 'Deleted the Strikeout of some text on a Document'
...
class CrocodocAnnotationTextboxEventTest(CrocodocBaseTest):
    ...
    expected_verb = 'Added a text element on a Document'
    expected_deleted_verb = 'Deleted a text element on a Document'
...
class CrocodocAnnotationDrawingEventTest(CrocodocBaseTest):
    ...
    expected_verb = 'Added a drawing element on a Document'
    expected_deleted_verb = 'Deleted a drawing element on a Document'
...
class CrocodocAnnotationPointEventTest(CrocodocBaseTest):
    ...
    expected_deleted_verb = 'Deleted a point element on a Document'
