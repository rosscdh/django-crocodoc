...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrocodocDocument.reviewer'
        db.add_column(u'dj_crocodoc_crocodocdocument', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrocodocDocument.reviewer'
        db.delete_column(u'dj_crocodoc_crocodocdocument', 'reviewer_id')
